...
export interface User {
  id: number;
  name: string;
  role?: ('admin' | 'clinical' | 'academic' | 'editor') | null;
  updatedAt: string;
  createdAt: string;
  email: string;
...
export interface Media {
  id: number;
  /**
   * A short literal description, in the active locale.
   */
  alt: string;
  /**
   * Photographer or source credit, if any.
   */
  credit?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface Department {
  ...
  name: string;
  /**
   * Locale-specific URL slug, e.g. cardiology / hridya-rog-vibhag.
   */
  slug: string;
  ...
  image?: (number | null) | Media;
  /**
   * Used on the department detail page.
   */
  longform?: {
    root: {
      type: string;
...
export interface Faculty {
  ...
  departments?: (number | Department)[] | null;
  /**
   * Optional link to the clinical roster, when this faculty also sees patients.
   */
  clinicalDoctor?: (number | null) | Doctor;
  bio?: {
    root: {
      type: string;
      children: {
...
export interface Location {
  id: number;
  name: string;
  kind?: ('main' | 'college' | 'opd' | 'other') | null;
  address: string;
  phones?:
    | {
        label: string;
...
export interface Setting {
  ...
  social?:
    | {
        platform?: ('facebook' | 'instagram' | 'youtube' | 'x' | 'linkedin') | null;
        url: string;
        id?: string | null;
      }[]
    | null;
